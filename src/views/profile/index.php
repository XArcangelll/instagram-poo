        ...
        <?php
            ...
            foreach($posts as $p){
              ?>
                <div class="card mt-2">
                    <div class="card-body">
                    <img class="rounded-circle" src="/instagram/public/img/photos/<?php echo $p->getUser()->getProfile() ?>" width="32" />
                 
                            <?php echo $p->getUser()->getUsername() ?>
                
                    </div>
                    <img src="/instagram/public/img/photos/<?php echo $p->getImage() ?>" style="object-fit: cover;" width="100%"  />
                    <div class="card-body">
